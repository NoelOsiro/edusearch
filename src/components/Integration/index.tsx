      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `PARTNERSHIPS`,
              subtitle: `Seamless Integration with Leading Educational Tools.`,
              description: `EDUSEARCH integrates with a wide range of educational tools and platforms, ensuring a comprehensive experience for both schools and students.`,
            }}
          />
          {/* <!-- Section Title End --> */}
        </div>
